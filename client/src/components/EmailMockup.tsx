              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6 w-full max-w-4xl">
                ...
                >
                  ...
                  <div className="p-4 sm:p-5 flex-1 flex flex-col">
                    <h3 className="text-sm sm:text-base font-semibold text-foreground mb-1.5 line-clamp-2 min-h-[2.5rem] sm:min-h-[3rem]" data-testid="text-project-1-title">
                ...
                >
                  ...
                  <div className="p-4 sm:p-5 flex-1 flex flex-col">
                    <h3 className="text-sm sm:text-base font-semibold text-foreground mb-1.5 line-clamp-2 min-h-[2.5rem] sm:min-h-[3rem]" data-testid="text-project-2-title">
