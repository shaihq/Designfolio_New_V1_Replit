...
export default function HeroSection() {
  ...
  return (
    <section ref={sectionRef} className="relative overflow-visible py-8 sm:py-12 md:py-16 px-6">
      ...
      <motion.div 
        ref={leftCardRef}
        className="absolute -left-40 -top-12 lg:-left-8 xl:-left-40 lg:top-20 xl:top-28 z-[31] will-change-transform"
        style={{
      ...
      <motion.div 
        ref={rightCardRef}
        className="absolute -right-32 -bottom-20 lg:-right-8 xl:-right-32 lg:top-32 xl:top-40 lg:bottom-auto z-[29] will-change-transform"
        style={{
