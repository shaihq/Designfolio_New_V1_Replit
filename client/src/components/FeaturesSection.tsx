  ...
  return (
    <section className="py-12 sm:py-16 md:py-24 px-6 bg-background">
      <div className="max-w-4xl mx-auto">
        <h2 className="font-heading font-semibold text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl text-center text-foreground mb-4 sm:mb-6" data-testid="text-features-heading">
