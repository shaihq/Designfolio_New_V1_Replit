      ...
      <div className="flex-1 w-full min-w-0 transition-all duration-300 relative z-10" style={{ marginRight: !isMobileOrTablet && (isThemePanelOpen || isEditTestimonialOpen) ? '320px' : '0' }}>
        ...
        <main className="pb-6">
          ...
          >
            ...
            {/* Profile Info */}
            <div className="p-8 pb-6 cursor-[url('/wavinghand.png'),_pointer]">
            ...
            {sectionOrder.map((sectionId, index) => {
              ...
              if (sectionId === 'works') {
                return (
                  ...
                  >
                  <Card className="bg-white/95 backdrop-blur-sm border-0 rounded-2xl p-6 mt-3 cursor-[url('/wavinghand.png'),_pointer]" style={{ boxShadow: '0 0 0 1px rgba(0,0,0,0.03), 0 0 40px rgba(0,0,0,0.015)' }}>
