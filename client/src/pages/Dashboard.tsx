      ...
      >
        ...
        >
          ...
          >
            ...
            {project.isHidden && (
              <motion.div 
                className="absolute top-3 right-3 bg-amber-100 text-amber-700 px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1.5"
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <motion.span
                  key={project.isHidden ? 'hidden-text' : 'visible-text'}
