        ...
        <main className="pb-6">
          ...
          <Card className="bg-white/95 backdrop-blur-sm border-0 rounded-2xl overflow-hidden mb-6 relative" style={{ boxShadow: '0 0 0 1px rgba(0,0,0,0.01), 0 0 40px rgba(0,0,0,0.015)' }}>
            ...
            <div 
              ...
              style={{
                background: 'linear-gradient(to bottom, #FAF7F4, #F6F2EF 40%, #F0EBE7 60%, #F6F2EF)',
                borderTopColor: 'rgba(246, 242, 239, 0.4)',
                boxShadow: 'inset 0 1px 2px rgba(255, 255, 255, 0.6), inset 0 -1px 2px rgba(0, 0, 0, 0.05)'
              }}
            >
