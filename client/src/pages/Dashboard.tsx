  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F6F2EF' }}>
      <div className="max-w-4xl mx-auto px-6">
        {/* Floating Navbar */}
        <div className="pt-6">
          <Card className="bg-white/95 backdrop-blur-sm border border-black/[0.06] rounded-2xl px-8 py-4 mb-6" style={{ boxShadow: '0 0 40px rgba(0,0,0,0.015)' }}>
        ...
        <main className="pb-6">
          {/* Profile Card */}
          <Card className="bg-white/95 backdrop-blur-sm border border-black/[0.06] rounded-2xl overflow-hidden mb-6 relative" style={{ boxShadow: '0 0 40px rgba(0,0,0,0.015)' }}>
            ...
            <div 
              ...
              style={{
                background: 'linear-gradient(135deg, #F0EBE7 0%, #F5F1ED 25%, #FAF8F5 45%, #FFFFFF 50%, #FAF8F5 55%, #F5F1ED 75%, #F0EBE7 100%)',
                boxShadow: 'inset 0 2px 3px rgba(255,255,255,0.7), inset 0 -2px 3px rgba(0,0,0,0.05), 0 1px 1px rgba(0,0,0,0.03)'
              }}
            >
          ...
          {/* My Works Section */}
          <Card className="bg-white/95 backdrop-blur-sm border border-black/[0.06] rounded-2xl p-8" style={{ boxShadow: '0 0 40px rgba(0,0,0,0.015)' }}>
