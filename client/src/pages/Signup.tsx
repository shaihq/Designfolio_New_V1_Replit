      ...
      <div className="relative">
        ...
        <div className="relative z-10 py-12 sm:py-16 md:py-20 lg:py-24 px-6">
          <div className="max-w-xl mx-auto">
            ...
            <div className="relative">
              <div className="absolute -top-8 left-1/2 -translate-x-1/2 z-20 bg-white rounded-2xl p-3 shadow-lg">
              ...
              <Card 
                className="relative p-6 sm:p-8 pt-12 sm:pt-14 bg-muted/40 border-border/30 overflow-visible shadow-none"
                style={{
